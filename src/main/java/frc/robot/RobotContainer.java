    ...
    public RobotContainer() {
        switch (Constants.currentMode) {
            ...
            case SIM:
                ...
                shooter = new Shooter(
                        new FeederIO() {
                        }, new ShooterIOSim(), new ShooterIOSim(), new ShooterIOSim());
                ...
                .whileTrue(
                        Commands.run(
                                () -> {
                                    ...
                                    Logger.recordOutput("SOTM/Distance No Lookahead", parms.distanceNoLookahead());
                                ...
                                .alongWith(DriveCommands
                                        .joystickDriveAtAngle(drive, () -> -driver.getLeftY() * 0.5, () -> -driver.getLeftX() * 0.5,
                                                () -> LauncherCalculator
                                                        .getInstance().getParameters(drive::getPose,
                ...
                .whileTrue(
                        Commands.run(
                                () -> {
                                    ...
                                    Logger.recordOutput(
                                            "Superstructure/Target/HoodAngleDeg",
                                            Math.toDegrees(solution.hoodAngleRad));
