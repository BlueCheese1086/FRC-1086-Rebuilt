...
public class FeederIOTalonFX implements FeederIO {
    ...
    public FeederIOTalonFX(int feedID) {
        ...
        feedConfig.TorqueCurrent.PeakForwardTorqueCurrent = 200.0; // In amps (estimated 200 amps is max it will ever
                                                                   // go)
        ...
        BaseStatusSignal.setUpdateFrequencyForAll(50.0, volts, statorCurrent, supplyCurrent, tempreature);
