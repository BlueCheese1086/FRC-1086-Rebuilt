...
public class ShootingManager {
    public static final Translation3d[] CAMERA_X_Y_Z_OFFSETS = new Translation3d[] {
            new Translation3d(
    ...
    private static final InterpolatingTreeMap<Double, Double> distanceToAngleDeg = new InterpolatingTreeMap<>(
            InverseInterpolator.forDouble(), Interpolator.forDouble());
    ...
    public void addVisionObservation(
        ...
        double visionFoM = VISION_BASE_FOM
    ...
    public ShotSolution calculateShotSolution(
        ...
        double staticExitVelocity = ShootingCalculator
        ...
        Translation3d vStatic = new Translation3d(
        ...
        Translation3d vRobot = new Translation3d(fieldSpeeds.vxMetersPerSecond, fieldSpeeds.vyMetersPerSecond, 0.0);
    ...
    private double limitRpm(double targetRpm, double timestampSec) {
        ...
        double limited = lastCommandedRpm + MathUtil.clamp(clamped - lastCommandedRpm, -maxDelta, maxDelta);
    ...
    public Translation3d[] calculateTrajectory(
        ...
        double exitVelocity = ShootingCalculator.calculateExitVelocityMetersPerSecondFromRpm(solution.flywheelRpm);
    ...
    private PoseSample getPoseSampleAt(double timestampSec) {
        ...
        for (PoseSample sample : poseBuffer) {
            if (sample.timestampSec >= timestampSec) {
                ...
                double t = (timestampSec - previous.timestampSec)
    ...
    private Pose2d blendPoses(Pose2d odomPose, Pose2d visionPose, double odomFom, double visionFom) {
        ...
        double rot = (odomPose.getRotation().getRadians() * odomWeight
