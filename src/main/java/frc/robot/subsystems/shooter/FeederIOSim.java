...
public class FeederIOSim implements FeederIO {
    ...
    public FeederIOSim() {
        feeder = new DCMotorSim(LinearSystemId.createDCMotorSystem(DCMotor.getKrakenX44Foc(1), ShooterConstants.Mechanical.J.in(KilogramSquareMeters), 1.0), DCMotor.getKrakenX44Foc(1));
    }
