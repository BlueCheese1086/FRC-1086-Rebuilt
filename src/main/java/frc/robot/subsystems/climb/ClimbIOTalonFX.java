...
public class ClimbIOTalonFX implements ClimbIO {
    ...
    public ClimbIOTalonFX(int id) {
        ...
        BaseStatusSignal.setUpdateFrequencyForAll(50.0, temp, velocity, positionSignal, statorCurrent, supplyCurrent,
                voltageSignal);
    ...
    public void updateInputs(ClimbIOInputs inputs) {
        BaseStatusSignal.refreshAll(temp, velocity, positionSignal, statorCurrent, supplyCurrent, voltageSignal);
        inputs.isConnected = BaseStatusSignal.isAllGood(temp, velocity, positionSignal, statorCurrent, supplyCurrent,
                voltageSignal);
    ...
    private Distance motorAngleToExtension(Angle motorAngle) {
        final Measure<DistanceUnit> extensionMeasure = motorAngle.timesRatio(ClimbConstants.kHangerExtensionPerMotorAngle);
