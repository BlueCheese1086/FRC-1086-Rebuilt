...
public class VisionIOLimelight implements VisionIO {
  ...
  public void updatePose(
      Pose2d robotPose) {
        limelight.getSettings().withRobotOrientation(new Orientation3d(new Rotation3d(robotPose.getRotation()), RadiansPerSecond.zero(),RadiansPerSecond.zero(),RadiansPerSecond.zero()));
  ...
  public void updateInputs(VisionInputs inputs) {
    ...
    if (poseEstimate.isPresent()) {
      ...
      inputs.type = estimatedPose.isMegaTag2 ?  ObservationType.LimeLightMegatag2 : ObservationType.LimeLightMegatag1;
