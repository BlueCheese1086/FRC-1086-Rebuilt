...
public class BatteryLogger extends SubsystemBase {
  ...
  private double batteryVoltage = RobotController.getBatteryVoltage();
  private double rioCurrent = 0.0;
  private double radioCurrent = 0.0;
  private double orangePiCurrent = 0.0;
